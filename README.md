# Hangman
A Hangman game that uses Google Cloud Endpoints, Google App Engine, Google Datastore, and Python for the backend, 
and an AngularJS application for the frontend.
...
##Files And Folders
 ...
 - words.json: Word bank used by the game.
